...
run:
	venv_yolo/bin/python3 learn.py

train:
	venv_yolo/bin/python3 train.py
train_v6:
	venv_yolo/bin/python3 train.py
...
build:
	...
	venv_yolo/bin/pip3 install -r requirements.txt
	# venv_yolo/bin/pip3 install -U ultralytics
	# venv_yolo/bin/pip3 uninstall ultralytics
	# venv_yolo/bin/install ultralytics=3.8.66

predict:
	venv_yolo/bin/python3 predict.py
